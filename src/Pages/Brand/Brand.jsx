    ...
    return (
        <div>
                ...
                <div id="slide2"
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className="flex flex-col justify-evenly items-center md:flex-row gap-5">
                            ...
                            <img src={''} className="w-10/12 md:w-1/3 hidden md:block"/>
                        </div>
                        <a href="#slide3" className="btn btn-circle bg-[#121212] border-0 text-white">❯</a>
                    </div>
                </div>
            ...
            <div className="max-w-5xl mx-auto py-16 px-4 md:px-6 lg:px-8">
                <h1 className="text-3xl md:text-4xl font-bold text-center pb-24"><span className="text-primary">Trending</span> Products</h1>
                {
                    detailsBrands.length > 0
                    ?
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
                    {
                        detailsBrands.map(product => <ProductCard 
                            key={product._id}
                            product={product}
                        ></ProductCard>)
                    }
